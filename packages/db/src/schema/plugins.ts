...
import type { PluginCategory, PluginStatus, MthPluginManifestV1 } from "@meowtieheightgent/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<MthPluginManifestV1>().notNull(),
