...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within MthPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Mth host.
 *
 ...
 */
export interface MthPluginManifestV1 {
   ...
   */
  minimumMthVersion?: PluginMinimumHostVersion;
