/**
 * Core types for the Mth plugin worker-side SDK.
 *
 * These types define the stable public API surface that plugin workers import
 * from `@meowtieheightgent/plugin-sdk`.  The host provides a concrete implementation
 * of `PluginContext` to the plugin at initialisation time.
 *
 * @see PLUGIN_SPEC.md §14 — SDK Surface
 * @see PLUGIN_SPEC.md §29.2 — SDK Versioning
 */
import type { MthPluginManifestV1, PluginStateScopeKind, PluginEventType, PluginToolDeclaration, PluginLauncherDeclaration, Company, Project, Issue, IssueComment, IssueDocument, IssueDocumentSummary, Agent, Goal } from "@meowtieheightgent/shared";
export type { MthPluginManifestV1, PluginJobDeclaration, PluginWebhookDeclaration, PluginToolDeclaration, PluginUiSlotDeclaration, PluginUiDeclaration, PluginLauncherActionDeclaration, PluginLauncherRenderDeclaration, PluginLauncherDeclaration, PluginMinimumHostVersion, PluginRecord, PluginConfig, JsonSchema, PluginStatus, PluginCategory, PluginCapability, PluginUiSlotType, PluginUiSlotEntityType, PluginLauncherPlacementZone, PluginLauncherAction, PluginLauncherBounds, PluginLauncherRenderEnvironment, PluginStateScopeKind, PluginJobStatus, PluginJobRunStatus, PluginJobRunTrigger, PluginWebhookDeliveryStatus, PluginEventType, PluginBridgeErrorCode, Company, Project, Issue, IssueComment, IssueDocument, IssueDocumentSummary, Agent, Goal, } from "@meowtieheightgent/shared";
/**
...
export interface ScopeKey {
    /** What kind of Mth object this state is scoped to. */
...
export interface PluginEntityUpsert {
    ...
    externalId?: string;
    /** Human-readable title for display in the Mth UI. */
    title?: string;
...
/**
 * `ctx.events` — subscribe to and emit Mth domain events.
 *
...
export interface PluginEventsClient {
    /**
     * Subscribe to a core Mth domain event or a plugin-namespaced event.
     *
 ...
 * This client resolves the reference through the Mth secret provider
...
export interface PluginSecretsClient {
     ...
     * in the Mth secret provider (e.g. `"MY_API_KEY"`).
     *
 ...
 * ```
 *
 * @see usePluginStream in `@meowtieheightgent/plugin-sdk/ui`
 */
