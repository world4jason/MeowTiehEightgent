 ...
 */
import type { MthPluginManifestV1, PluginLauncherBounds, PluginLauncherRenderContextSnapshot, PluginStateScopeKind, Company, Project, Issue, IssueComment, IssueDocument, IssueDocumentSummary, Agent, Goal } from "@meowtieheightgent/shared";
export type { PluginLauncherRenderContextSnapshot } from "@meowtieheightgent/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Mth messages.
 */
...
export interface InitializeParams {
    ...
    instanceInfo: {
        /** UUID of this Mth instance. */
        instanceId: string;
        /** Semver version of the running Mth host. */
        hostVersion: string;
    };
    /** Host API version. */
    apiVersion: number;
