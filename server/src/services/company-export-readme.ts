 ...
 */
import type { CompanyPortabilityManifest } from "@meowtieheightgent/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Mth](https://mth.ing)");
  lines.push("");
