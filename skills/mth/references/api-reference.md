...
Detailed reference for the Mth control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
POST /api/companies/{companyId}/projects
{
  ...
  "workspace": {
    "name": "mth-mobile",
    "cwd": "/Users/me/mth-mobile",
    "repoUrl": "https://github.com/acme/mth-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `mth-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
